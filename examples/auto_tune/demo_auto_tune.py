...
# sift_path = "sift1meg/sift_"
sift_path = "sift10k/siftsmall_"

t0 = time.time()

print("load data")

xt = fvecs_read(sift_path + "learn.fvecs")
xb = fvecs_read(sift_path + "base.fvecs")
xq = fvecs_read(sift_path + "query.fvecs")

d = xt.shape[1]

print("load GT")

gt = ivecs_read(sift_path + "groundtruth.ivecs")
gt = gt.astype('int64')
k = gt.shape[1]
